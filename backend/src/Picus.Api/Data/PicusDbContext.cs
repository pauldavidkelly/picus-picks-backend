...
public class PicusDbContext : DbContext
{
    ...
    private void SeedTeams(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Team>().HasData(
            ...
            // AFC East
            new Team { Id = 9, ExternalTeamId = "134930", Name = "Bills", Abbreviation = "BUF", City = "Buffalo", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/buf.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/buf.png", PrimaryColor = "#00338D", SecondaryColor = "#C60C30", TertiaryColor = "#FFFFFF", Conference = ConferenceType.AFC, Division = DivisionType.East },
            new Team { Id = 10, ExternalTeamId = "134931", Name = "Dolphins", Abbreviation = "MIA", City = "Miami", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/mia.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/mia.png", PrimaryColor = "#008E97", SecondaryColor = "#FC4C02", TertiaryColor = "#005778", Conference = ConferenceType.AFC, Division = DivisionType.East },
            new Team { Id = 11, ExternalTeamId = "134932", Name = "Patriots", Abbreviation = "NE", City = "New England", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/ne.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/ne.png", PrimaryColor = "#002244", SecondaryColor = "#C60C30", TertiaryColor = "#B0B7BC", Conference = ConferenceType.AFC, Division = DivisionType.East },
            new Team { Id = 12, ExternalTeamId = "134933", Name = "Jets", Abbreviation = "NYJ", City = "New York", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/nyj.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/nyj.png", PrimaryColor = "#125740", SecondaryColor = "#000000", TertiaryColor = "#FFFFFF", Conference = ConferenceType.AFC, Division = DivisionType.East },
            
            // AFC West
            new Team { Id = 13, ExternalTeamId = "134934", Name = "Broncos", Abbreviation = "DEN", City = "Denver", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/den.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/den.png", PrimaryColor = "#FB4F14", SecondaryColor = "#002244", TertiaryColor = "#FFFFFF", Conference = ConferenceType.AFC, Division = DivisionType.West },
            new Team { Id = 14, ExternalTeamId = "134935", Name = "Chiefs", Abbreviation = "KC", City = "Kansas City", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/kc.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/kc.png", PrimaryColor = "#E31837", SecondaryColor = "#FFB81C", TertiaryColor = "#FFFFFF", Conference = ConferenceType.AFC, Division = DivisionType.West },
            new Team { Id = 15, ExternalTeamId = "134936", Name = "Raiders", Abbreviation = "LV", City = "Las Vegas", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/lv.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/lv.png", PrimaryColor = "#000000", SecondaryColor = "#A5ACAF", TertiaryColor = "#FFFFFF", Conference = ConferenceType.AFC, Division = DivisionType.West },
            new Team { Id = 16, ExternalTeamId = "134937", Name = "Chargers", Abbreviation = "LAC", City = "Los Angeles", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/lac.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/lac.png", PrimaryColor = "#0080C6", SecondaryColor = "#FFC20E", TertiaryColor = "#FFFFFF", Conference = ConferenceType.AFC, Division = DivisionType.West },
            ...
            // NFC West
            new Team { Id = 29, ExternalTeamId = "134950", Name = "Cardinals", Abbreviation = "ARI", City = "Arizona", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/ari.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/ari.png", PrimaryColor = "#97233F", SecondaryColor = "#000000", TertiaryColor = "#FFB612", Conference = ConferenceType.NFC, Division = DivisionType.West },
            new Team { Id = 30, ExternalTeamId = "134951", Name = "Rams", Abbreviation = "LAR", City = "Los Angeles", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/lar.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/lar.png", PrimaryColor = "#003594", SecondaryColor = "#FFA300", TertiaryColor = "#FFFFFF", Conference = ConferenceType.NFC, Division = DivisionType.West },
            new Team { Id = 31, ExternalTeamId = "134952", Name = "49ers", Abbreviation = "SF", City = "San Francisco", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/sf.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/sf.png", PrimaryColor = "#AA0000", SecondaryColor = "#B3995D", TertiaryColor = "#FFFFFF", Conference = ConferenceType.NFC, Division = DivisionType.West },
            new Team { Id = 32, ExternalTeamId = "134953", Name = "Seahawks", Abbreviation = "SEA", City = "Seattle", IconUrl = "https://a.espncdn.com/i/teamlogos/nfl/500/sea.png", BannerUrl = "https://a.espncdn.com/i/teamlogos/nfl/500-dark/sea.png", PrimaryColor = "#002244", SecondaryColor = "#69BE28", TertiaryColor = "#A5ACAF", Conference = ConferenceType.NFC, Division = DivisionType.West }
        );
    }
